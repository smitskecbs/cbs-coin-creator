...
export async function createToken(
  ...
  try {
    setTokenStatus('Preparing token creation...');

    console.log('Connected to:', params.network);
    console.log('Token name:', params.tokenName);
    console.log('Symbol:', params.symbol);
    console.log('Decimals:', params.decimals);
    console.log('Supply:', params.supply);
    console.log('Revoke mint authority:', params.revokeMintAuthority);
    console.log('Revoke freeze authority:', params.revokeFreezeAuthority);
    ...
    setTokenStatus(`
      <strong>Devnet token created</strong>
      <br><br>
      ...
      <small>
        Initial supply minted to your wallet<br>
        Mint authority revoked: ${params.revokeMintAuthority ? 'Yes' : 'No'}<br>
        Freeze authority revoked: ${params.revokeFreezeAuthority ? 'Yes' : 'No'}<br>
        Cost: Solana network fee only<br>
        No platform fee
      </small>
    `);
